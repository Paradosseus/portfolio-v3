...
const Header = () => {
  return (
    <div className='border-b border-[rgba(255,255,255,.1)] sticky top-0 bg-[rgba(0,0,0,.5] backdrop-blur-md'>
      ...
      <nav className='max-w-7xl mx-auto lg:py-4 py-3 flex justify-between items-center'>
        <div className='logo'>
